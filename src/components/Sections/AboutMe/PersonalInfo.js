  ...
  return (
    <div className="personal-info padd-15">
      <div className="row">
        ...
        <div className="info-item padd-15">
         <p><i class="fa-solid fa-graduation-cap"></i>  Degree : <span>BS Information Technology</span></p>
        </div>
        <div className="info-item padd-15">
        ...
        <div className="info-item padd-15">
          <p><i class="fa-solid fa-phone"></i>  Phone : <span>+63-945-560-2846</span></p>
        </div>
        <div className="info-item padd-15">
          <p><i class="fa-solid fa-city"></i>  City : <span>Laguna</span></p>
        </div>
        <div className="info-item padd-15">
          <p><i class="fa-solid fa-laptop"></i>  Freelance : <span style={{color:'green'}}>Available</span></p>
        </div>
      </div>
      <div className="row">
